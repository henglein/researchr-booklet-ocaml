\header{VMCAI}{Watercourt}{2018/01/07}{VMCAI Day -- 1}
\label{VMCAI-07}
...
\header{VMCAI}{Watercourt}{2018/01/08}{VMCAI Day -- 2}
\label{VMCAI-08}
...
\header{PEPM}{Crocker}{2018/01/08}{PEPM Day -- 1}
\label{PEPM-08}
...
\header{PADL}{Rose}{2018/01/08}{PADL Day -- 1}
\label{PADL-08}
...
\header{CPP}{Museum A}{2018/01/08}{CPP Day -- 1}
\label{CPP-08}
...
\closesession
\session{18:15 -- 20:15}{CPP Reception}
\slot{18:15}{CPP Reception}
\closesession
\newpage

\header{TutorialFest}{}{2018/01/08}{TutorialFest}
\label{TutorialFest-08}

\session{09:00 -- 10:30}{Code Obfuscation \hfill Bradbury}
\slot{09:00}{Code Obfuscation - A Hacking view on program analysis and understanding. }
\authors{%
\author{Roberto Giacobazzi}
}
\closesession
\session{09:00 -- 10:30}{Equational reasoning for probabilistic programming \hfill Widney}
\slot{09:00}{Equational reasoning for probabilistic programming.}
\authors{%
\author{Chung-chieh Shan}
}
\closesession
\session{09:00 -- 10:30}{Message-Passing Concurrency and Substructural Logics \hfill Museum B}
\slot{09:00}{Message-Passing Concurrency and Substructural Logics}
\authors{%
\author{Frank Pfenning}
}
\closesession
\session{09:00 -- 10:30}{Programming and Reasoning with Infinite Data in Isabelle \hfill Hershey}
...
\closesession
\session{11:00 -- 12:00}{Code Obfuscation \hfill Bradbury}
\slot{11:00}{Code Obfuscation - A Hacking view on program analysis and understanding. }
\authors{%
\author{Roberto Giacobazzi}
}
\closesession
\session{11:00 -- 12:00}{Equational reasoning for probabilistic programming \hfill Widney}
\slot{11:00}{Equational reasoning for probabilistic programming.}
\authors{%
\author{Chung-chieh Shan}
}
\closesession
\session{11:00 -- 12:00}{Message-Passing Concurrency and Substructural Logics \hfill Museum B}
\slot{11:00}{Message-Passing Concurrency and Substructural Logics}
\authors{%
\author{Frank Pfenning}
}
\closesession
\session{11:00 -- 12:00}{Programming and Reasoning with Infinite Data in Isabelle \hfill Hershey}
...
\closesession
\session{14:00 -- 15:30}{Computational Higher Type Theory \hfill Bradbury}
\slot{14:00}{Computational Higher Type Theory}
\authors{%
\author{Robert Harper and Carlo Angiuli}
}
\closesession
\session{14:00 -- 15:30}{Introduction to Algebraic Program analysis \hfill Widney}
...
\closesession
\newpage
\session{14:00 -- 15:30}{Iris - A Higher-Order Concurrent Separation Logic \hfill Museum B}
...
\closesession
\session{14:00 -- 15:30}{Relational Interpreters for Program Synthesis \hfill Hershey}
\slot{14:00}{One Weird Trick: Relational Interpreters for Program Synthesis.}
\authors{%
\author{William E. Byrd and Gregory Rosenblatt}
}
\closesession
\session{16:00 -- 17:00}{Computational Higher Type Theory \hfill Bradbury}
\slot{16:00}{Computational Higher Type Theory}
\authors{%
\author{Robert Harper and Carlo Angiuli}
}
\closesession
\session{16:00 -- 17:00}{Introduction to Algebraic Program analysis \hfill Widney}
\slot{16:00}{Introduction to Algebraic Program analysis.}
\authors{%
\author{Zachary Kincaid and Thomas Reps}
}
\closesession
\session{16:00 -- 17:00}{Iris - A Higher-Order Concurrent Separation Logic \hfill Museum B}
\slot{14:00}{Iris - A Modular Foundation for Higher-Order Concurrent Separation Logic.}
\authors{%
\author{Jacques-Henri Jourdan and Robbert Krebbers}
}
\closesession
\session{16:00 -- 17:00}{Relational Interpreters for Program Synthesis \hfill Hershey}
...
\header{VMCAI}{Watercourt}{2018/01/09}{VMCAI Day -- 3}
\label{VMCAI-09}
...
\header{PEPM}{Crocker}{2018/01/09}{PEPM Day -- 2}
\label{PEPM-09}
...
\header{PADL}{Rose}{2018/01/09}{PADL Day -- 2}
\label{PADL-09}
...
\closesession
\session{16:00 -- 17:30}{Best Papers }
...
\header{CPP}{Museum A}{2018/01/09}{CPP Day -- 2}
\label{CPP-09}
...
\header{NetPL}{Hershey}{2018/01/09}{NetPL}
\label{NetPL-09}
...
\authors{%
\author{Nate Foster,}
\author{David Walker and Barath Raghavan}
}
\slot{17:30}{Wrap Up}
\authors{%
\author{Marco Canini,}
...
\header{PPS}{Bradbury}{2018/01/09}{PPS}
\label{PPS-09}
...
\header{PLMW}{Museum B}{2018/01/09}{PLMW}
\label{PLMW-09}
...
\header{POPL}{}{2018/01/10}{POPL Day -- 1}
\label{POPL-10}

\session{08:30 -- 10:00}{Awards \& Keynote-I \hfill Bunker Hill / Watercourt}
\slot{08:30}{Milner Award Lecture: The Type Soundness Theorem That You Really Want to Prove (and Now You Can)}
\authors{%
\author{Derek Dreyer}
}
\closesession
\session{10:30 -- 12:10}{Strings \hfill Bunker Hill}
...
\closesession
\session{10:30 -- 12:10}{Types and Effects \hfill Watercourt}
...
\closesession
\session{13:40 -- 15:20}{Interpretation and Evaluation \hfill Watercourt}
...
\closesession
\newpage
\session{13:40 -- 15:20}{Verification I \hfill Bunker Hill}
...
\closesession
\session{15:50 -- 17:30}{Memory and Concurrency \hfill Bunker Hill}
...
\closesession
\session{15:50 -- 17:30}{Types \hfill Watercourt}
...
\header{POPL}{}{2018/01/11}{POPL Day -- 2}
\label{POPL-11}

\session{08:30 -- 10:00}{Keynote-II \hfill Bunker Hill / Watercourt}
\slot{08:30}{Some Principles of Differential Programming Languages}
\authors{%
\author{Gordon Plotkin}
}
\closesession
\session{10:30 -- 12:10}{Consistency \hfill Bunker Hill}
...
\closesession
\session{10:30 -- 12:10}{Program Analysis I \hfill Watercourt}
...
\closesession
\session{13:40 -- 15:20}{Outside the box \hfill Watercourt}
...
\closesession
\session{13:40 -- 15:20}{Termination \hfill Bunker Hill}
...
\closesession
\session{15:50 -- 16:40}{Dependent Types \hfill Watercourt}
...
\closesession
\session{15:50 -- 16:40}{Language Design \hfill Bunker Hill}
...
\closesession
\session{17:00 -- 18:00}{Business Meeting \hfill Bunker Hill / Watercourt}
...
\header{SRC}{Bunker Hill / Watercourt}{2018/01/11}{SRC}
\label{SRC-11}
...
\header{POPL}{}{2018/01/12}{POPL Day -- 3}
\label{POPL-12}

\session{08:30 -- 10:00}{Keynote-III \hfill Bunker Hill / Watercourt}
\slot{08:30}{Formal Methods and the Law}
\authors{%
\author{Sarah Lawsky}
}
\closesession
\session{10:30 -- 12:10}{Dynamic Languages \hfill Watercourt}
...
\closesession
\session{10:30 -- 12:10}{Testing and Verification \hfill Bunker Hill}
...
\closesession
\session{13:40 -- 15:20}{Probability \hfill Watercourt}
...
\session{13:40 -- 15:20}{Program Analysis II \hfill Bunker Hill}
...
\closesession
\session{15:50 -- 17:05}{Synthesis \hfill Bunker Hill}
\slot{15:50}{Strategy Synthesis for Linear Arithmetic Games}
\authors{%
\author{Azadeh Farzan and Zachary Kincaid}
}
\slot{16:15}{Bonsai: Synthesis-Based Reasoning for Type Systems}
\authors{%
\author{Kartik Chandra and Rastislav Bodik}
}
\slot{16:40}{Program Synthesis using Abstraction Refinement}
\authors{%
\author{Xinyu Wang,}
\author{Isil Dillig and Rishabh Singh}
}
\closesession
\session{15:50 -- 17:05}{Types for State \hfill Watercourt}
...
\slot{16:15}{Recalling a Witness: Foundations and Applications of Monotonic State}
\authors{%
\author{Danel Ahman,}
\author{Cédric Fournet,}
\author{Cătălin Hriţcu,}
...
\slot{16:40}{RustBelt: Securing the Foundations of the Rust Programming Language}
\authors{%
\author{Ralf Jung,}
...
\header{CoqPL}{Watercourt A}{2018/01/13}{CoqPL}
\label{CoqPL-13}
...
\header{OBT}{Crocker}{2018/01/13}{OBT}
\label{OBT-13}
...
\header{PriSC}{Hershey}{2018/01/13}{PriSC}
\label{PriSC-13}
...
\slot{11:30}{Short Talks}
\closesession
\session{13:30 -- 15:30}{Session 2}
\slot{13:30}{Building Secure SGX Enclaves using F*, C/C++ and X64}
\authors{%
