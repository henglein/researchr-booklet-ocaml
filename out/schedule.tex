...
\overview{20th International Symposium on  Practical Aspects of Declarative Languages }{CPP Day -- 1}{\pageref{CPP-08}}
\overview{CPP 2018 - The 7th ACM SIGPLAN International Conference on Certified Programs and Proofs}{PADL Day -- 1}{\pageref{PADL-08}}
...
\overview{20th International Symposium on  Practical Aspects of Declarative Languages }{CPP Day -- 2}{\pageref{CPP-09}}
\overview{CPP 2018 - The 7th ACM SIGPLAN International Conference on Certified Programs and Proofs}{PADL Day -- 2}{\pageref{PADL-09}}
...
\overview{NetPL 2018}{NetPL}{\pageref{NetPL-13}}
...
\header{CPP}{PADL}{2018/01/08}{CPP Day -- 1}
\label{CPP-08}
...
\header{PADL}{CPP}{2018/01/08}{PADL Day -- 1}
\label{PADL-08}
...
\header{CPP}{PADL}{2018/01/09}{CPP Day -- 2}
\label{CPP-09}

\session{09:10 -- 10:00}{5.Invited Talk II}
\slot{09:10}{INVITED TALK: Declarative Algorithms on Big Data: a Logic-Based Solution}
\authors{%
\author{Carlo Zaniolo}
}
\closesession
\session{10:30 -- 12:00}{6.Functional Programming}
...
\closesession
\session{13:30 -- 15:30}{7.Answer Set Programming}
...
\closesession
\session{16:00 -- 18:00}{8.Best Papers; 9.PANEL on Future of Declarative Languages and Applications; 10.Closing;}
...
\header{PADL}{CPP}{2018/01/09}{PADL Day -- 2}
\label{PADL-09}

\session{09:10 -- 10:00}{Invited Talk by Brigitte Pientka}
\slot{09:10}{POPLMark Reloaded: Mechanizing Logical Relations Proofs (Invited Talk)}
\authors{%
...
\slot{09:10}{CoqHammer: Strong Automation for Program Verification}
\authors{%
...
\authors{%
\author{Matthieu Sozeau and Yves Bertot}
}
\closesession
