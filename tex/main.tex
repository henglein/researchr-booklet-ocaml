...
% Cover
\incgraph[documentpaper][width=\paperwidth,height=\paperheight]{img/cover.pdf}


\input{out/overview}
\input{tex/preface}
\input{tex/aec-report}
\input{tex/committees}
\ifpictures \input{tex/floorplan} \fi
\input{tex/keynotes}
\input{tex/social}
\input{out/schedule}
% \input{out/schedule-final}
\ifpictures\else \header{Notes}{}{}{Notes} \fi \newpage

% Back cover with sponsors
%\input{tex/sponsors}
\ \newpage 
\incgraph[documentpaper][width=\paperwidth,height=\paperheight]{img/backcover.pdf}
\end{document}
